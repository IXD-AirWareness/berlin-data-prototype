...
fun Data.PollutantList.mean(): Data.PollutantList {
    val pollutantMeans = mutableListOf<Data.Pollutant>()

    this.pollutantList.groupBy { it.pollutantType }.forEach { type, pollutantList ->
    ...
    return Data.PollutantList(pollutantMeans)
}
